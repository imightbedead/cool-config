...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/imightbedead/whitelists/main/whitelist2.json", true))
end)
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/imightbedead/VapeV4ForRobloxFIX/wiki/Turning-on-Highlights")
